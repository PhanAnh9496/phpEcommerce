...
<div class="header-top">
    <div class="header-bottom">
        <div class="container">
            <div class="logo">
                <a href="http://localhost:8080/ShopOnline/home"><h1>Fashion Store</h1></a>
            </div>
            <div class="top-nav">
                <ul class="memenu skyblue">
                    <li><a href="home">Trang chủ</a></li>
                    <?php include_once('fix_mysql.inc.php'); 
                        foreach ($parent_menus as $parent_menu): $parentId = $parent_menu['Id']; ?>
            ...
            <div class="cart box_1">
                <a href="cart"><i class="glyphicon glyphicon-shopping-cart"></i> Giỏ hàng : <?php 
                include_once('fix_mysql.inc.php');
